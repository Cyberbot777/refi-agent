---
description: "Use when: working on AWS Bedrock AgentCore deployment, Dockerfiles, agent entrypoints, production agent configuration, or deployment YAML files."
applyTo: "**"
---
